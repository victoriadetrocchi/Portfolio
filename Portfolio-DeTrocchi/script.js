/* ======================================================== */
/* SCRIPT PRINCIPAL: TRADUCCIONES Y SLIDER DE PROYECTOS     */
/* ======================================================== */
...
if (menuIcon && navbar) {
    ...
    // Índices iniciales para los 2 sliders [Buffet, Zummax]
    let slideIndex = [1, 1];
    // Nombres de las clases únicas para cada grupo de imágenes
    let slideId = ["mySlides1", "mySlides2"];

    // Inicializamos ambos sliders
    showSlides(1, 0);
    showSlides(1, 1);

    // Función que llaman las flechas
    ...
    function showSlides(n, no) {
        ...
        // Aseguramos que la imagen exista antes de mostrarla
